...
已封存的官方方法对齐版覆盖 2025-01-02 至 2025-12-17、233 个交易日。预先指定的
mean 信号含费累计收益为 7.03%，同期沪深300为 16.30%，含费超额为 -9.27%，最大
回撤为 -11.78%。这个结果说明它适合作为“方法复现与全栈学习基线”，不支持稳定
alpha 或实盘有效性的主张。

当前正式结果的指标和正确解释见
[2026-08-12 Small 正式评估说明](docs/RESULTS_20260812.md)和
[2026-08-13 Base 正式评估说明](docs/RESULTS_BASE_20260813.md)。严格 PIT 轨在 2025
